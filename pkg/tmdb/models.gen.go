...
type Collection struct {
	...
	Parts      []MovieListItemWithMediaType `json:"parts"`
...
// CollectionListItem defines model for CollectionListItem.
...
// CollectionListPage defines model for CollectionListPage.
...
type Company struct {
	...
	// OriginCountry [ISO 3166-1 alpha-2 code](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2)
	OriginCountry *CountryCode `json:"origin_country,omitempty"`
	ParentCompany *string      `json:"parent_company,omitempty"`
}

// CompanyBase defines model for CompanyBase.
...
type Country struct {
	...
	// Iso31661 [ISO 3166-1 alpha-2 code](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2)
	Iso31661   CountryCode `json:"iso_3166_1"`
	NativeName *string     `json:"native_name,omitempty"`
}

// CountryCode [ISO 3166-1 alpha-2 code](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2)
...
type Movie struct {
	...
	BelongsToCollection *CollectionBase      `json:"belongs_to_collection,omitempty"`
	...
	Keywords            *MovieKeywordList    `json:"keywords,omitempty"`
	OriginCountry       *[]CountryCode       `json:"origin_country,omitempty"`
	OriginalLanguage    string               `json:"original_language"`
	...
	Recommendations     *MultiListPage       `json:"recommendations,omitempty"`
	ReleaseDate         *openapi_types.Date  `json:"release_date,omitempty"`
	Revenue             *int64               `json:"revenue,omitempty"`
	Runtime             *int                 `json:"runtime,omitempty"`
	Similar             *MovieListPage       `json:"similar,omitempty"`
...
// MovieKeywordList defines model for MovieKeywordList.
type MovieKeywordList struct {
	Id       *int      `json:"id,omitempty"`
...
// MovieAppendToResponse * `alternative_titles` - Append alternative titles for a movie * `similar` - Append similar movies based on genres and keywords
